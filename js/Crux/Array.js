Array.prototype.setSlotsIfAbsent(
{
	...
	initWithArray:function(a)
	{
		...
		//console.log("Array.initWithArray(" + JSON.stringify(a) + ")")
		
		var self = this;
		a.forEach(function (dict, i)
		{			
			//console.log("dict[" + i + "] = " + JSON.stringify(dict) + ")")
			var instance = Proto.instanceFromDict(dict);
